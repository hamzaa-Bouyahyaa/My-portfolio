...
const Services = () => {
  return (
    <ServicesContainer id="services">
      ...
      <ServicesWrapper>
        <a
          href="https://tunicare.netlify.app/"
          target="_blank"
          style={{
            textDecoration: "none",
            color: "#000",
        ...
        >
          <ServicesCard>
            ...
            <ServicesP>
              Web platform primarily intended for patients to make an
              appointment online.
            </ServicesP>
          </ServicesCard>
        </a>
        <a
          href="https://tunicare-pro.netlify.app/"
          target="_blank"
          style={{
            textDecoration: "none",
            color: "#000",
        ...
        >
          <ServicesCard>
            ...
            <ServicesP>
              Web platform primarily intended for doctors to have a connected
              medical practice.
            </ServicesP>
          </ServicesCard>
        </a>
        ...
        <a
          href="https://weather-app-bh.netlify.app/"
          target="_blank"
        ...
        >
          <ServicesCard>
            ...
            <ServicesP>
              This web application can help you prepare for what Mother Nature
              has in store.
            </ServicesP>
          </ServicesCard>
        </a>
        <a
          href="https://github.com/hamzaa-Bouyahyaa/Alan-Ai-Voice-Assistant-with-ReactJs"
          target="_blank"
          style={{ textDecoration: "none", color: "#000" }}
        >
          <ServicesCard>
            ...
            <ServicesP>
              Conversational voice controlled react news app using Alan-Ai
            </ServicesP>
          </ServicesCard>
        </a>
        <a
          href="https://video-meeting-by-bouyahya-hamza.netlify.app/"
          target="_blank"
          style={{ textDecoration: "none", color: "#000" }}
        >
          <ServicesCard>
            ...
            <ServicesP>
              Scalable video chat application including Poll concept
            </ServicesP>
          </ServicesCard>
        </a>
        <a
          href="https://uploader-app-by-bouyahya-hamza.netlify.app/"
          target="_blank"
          style={{ textDecoration: "none", color: "#000" }}
        >
          <ServicesCard>
            ...
            <ServicesP>
              This web application is for fun. it can help you to upload your
              files, starring them, etc.
            </ServicesP>
          </ServicesCard>
        </a>
      </ServicesWrapper>
